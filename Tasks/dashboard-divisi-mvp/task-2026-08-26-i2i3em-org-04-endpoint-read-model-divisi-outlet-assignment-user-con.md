---
id: task-2026-08-26-i2i3em
title: '[ORG-04] Endpoint/read model divisi, outlet, assignment, user context'
status: blocked
priority: high
type: other
assignee: ''
...
Done when: FE menerima pilihan filter hanya sesuai scope. Owner: BE, size M.

## Acceptance Criteria

- [ ] Filter FE sesuai scope server
