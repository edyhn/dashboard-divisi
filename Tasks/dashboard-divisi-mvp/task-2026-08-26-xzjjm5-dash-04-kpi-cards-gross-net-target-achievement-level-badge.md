---
id: task-2026-08-26-xzjjm5
title: '[DASH-04] KPI cards gross/net/target/achievement + level badge'
status: blocked
priority: high
type: other
assignee: ''
...
Done when: nilai, label, comparator, status, level selalu tampil. Owner: FE, size M.

## Acceptance Criteria

- [ ] Nilai+label+comparator+status+level tampil
