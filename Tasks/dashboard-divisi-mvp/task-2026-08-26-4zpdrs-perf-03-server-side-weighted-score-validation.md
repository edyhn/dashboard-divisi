---
id: task-2026-08-26-4zpdrs
title: '[PERF-03] Server-side weighted score + validation'
status: blocked
priority: high
type: other
assignee: ''
...
Done when: skor di luar rentang/bobot tidak valid ditolak server-side. Owner: BE/QA, size M.

## Acceptance Criteria

- [ ] Skor di luar rentang ditolak
