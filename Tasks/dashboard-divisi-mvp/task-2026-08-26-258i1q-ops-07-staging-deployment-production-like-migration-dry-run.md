---
id: task-2026-08-26-258i1q
title: '[OPS-07] Staging deployment + production-like migration dry-run'
status: blocked
priority: medium
type: other
assignee: ''
...
Done when: deploy/rollback tidak merusak data yang telah dimigrasi. Owner: DevOps, size M.

## Acceptance Criteria

- [ ] Deploy/rollback aman utk data
