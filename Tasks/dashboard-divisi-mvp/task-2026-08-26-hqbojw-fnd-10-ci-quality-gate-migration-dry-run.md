---
id: task-2026-08-26-hqbojw
title: '[FND-10] CI quality gate + migration dry-run'
status: blocked
priority: high
type: other
assignee: ''
...
Outcome: CI quality gate + migration dry-run. Done when: PR diblokir bila lint/type/test/migration check gagal. Owner: DevOps, size S.

## Acceptance Criteria

- [ ] PR diblokir saat gate gagal
