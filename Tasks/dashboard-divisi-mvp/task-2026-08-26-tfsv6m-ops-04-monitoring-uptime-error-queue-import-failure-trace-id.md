---
id: task-2026-08-26-tfsv6m
title: '[OPS-04] Monitoring uptime/error/queue/import failure/trace_id'
status: blocked
priority: medium
type: other
assignee: ''
...
Done when: alert & dashboard operasional; tanpa data sensitif di telemetri. Owner: DevOps, size M.

## Acceptance Criteria

- [ ] Alert & dashboard ops tersedia
