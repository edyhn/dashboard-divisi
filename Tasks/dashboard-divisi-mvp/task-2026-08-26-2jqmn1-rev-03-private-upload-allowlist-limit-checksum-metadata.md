---
id: task-2026-08-26-2jqmn1
title: '[REV-03] Private upload: allowlist, limit, checksum, metadata'
status: blocked
priority: high
type: other
assignee: ''
...
Outcome: private file upload dgn allowlist, size limit, checksum, metadata. Done when: file tidak public; duplikasi dapat dideteksi. Owner: BE, size M.

## Acceptance Criteria

- [ ] File privat & duplikasi terdeteksi
