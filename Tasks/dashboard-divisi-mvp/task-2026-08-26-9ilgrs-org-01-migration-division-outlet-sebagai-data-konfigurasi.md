---
id: task-2026-08-26-9ilgrs
title: '[ORG-01] Migration Division & Outlet sebagai data konfigurasi'
status: blocked
priority: high
type: other
assignee: ''
...
Business input required: nama/kode resmi 6 divisi & daftar outlet awal (Backlog §4.1). Outcome: Division & Outlet sbg data konfigurasi. Done when: enam divisi ter-seed; divisi baru bisa ditambah tanpa deploy kode. Owner: DB/BE, size S.

## Acceptance Criteria

- [ ] Divisi baru tanpa deploy kode
